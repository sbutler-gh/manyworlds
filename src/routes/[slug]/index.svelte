...
<div style="position: relative;">
    <a style="display: block; margin-left: auto; width: fit-content; margin-top:20px;" href="https://meet.jit.si/{this_page?.slug}"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-external-link" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="#597e8d" fill="none" stroke-linecap="round" stroke-linejoin="round">
